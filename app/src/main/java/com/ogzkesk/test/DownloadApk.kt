...
class DownloadApk(private val context: Context) : AppCompatActivity() {

    @JvmOverloads
    fun startDownloadingApk(url: String, fileName: String = "new_release") {
    ...
    private class DownloadNewVersion(
        ...
        override fun doInBackground(vararg p0: String?): Boolean {
            ...
            try {
                ...
                val totalSize = c.contentLength.toFloat()
